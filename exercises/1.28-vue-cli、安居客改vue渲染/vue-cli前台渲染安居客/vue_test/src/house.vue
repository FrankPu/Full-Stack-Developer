  ...
  <div class="all2-div">
    ...
    <div class="contain-div">
      ...
      <div class="basicdetail-div">
          ...
          <div class="basicprice-div">最新开盘：预计{{houseData.sale_time}}开盘 </div>
          <div class="basicprice-div">交房时间：{{houseData.submit_time}}</div>
          <div class="basicprice-div">建筑类型：{{houseData.building_type}} </div>
      </div>
    </div>
